...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.layout_variables.setWidget(2, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_6)
        self.le_drawevery = QtWidgets.QLineEdit(parent=self.formLayoutWidget_3)
        self.le_drawevery.setObjectName("le_drawevery")
        self.layout_variables.setWidget(2, QtWidgets.QFormLayout.ItemRole.FieldRole, self.le_drawevery)
        ...
        self.verticalLayoutWidget_2.setGeometry(QtCore.QRect(10, 530, 141, 221))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.cb_usoGPU.setToolTip(_translate("MainWindow", "<html><head/><body><p><span style=\" font-weight:600; color:#ff2600;\">EXPERIMENTAL:</span> Esta opción sólo se puede seleccionar <span style=\" font-style:italic;\">antes de comenzar el entrenamiento por primera vez</span>. Si deseas modificar su valor una vez comenzado el entrenamiento, debes:<br/>1. Guardar el modelo entrenado<br/>2. Salir de la aplicación<br/>3. Arrarcar de nuevo la aplicación<br/>4. Seleccionar si deseas usar o no GPU<br/>5. Cargar modelo entrenado<br/>6. Continuar el entrenamiento</p></body></html>"))
